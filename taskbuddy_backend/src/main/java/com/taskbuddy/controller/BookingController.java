...
public class BookingController {
    ...
    public ResponseEntity<BookingResponse> createBooking(
        ...
        return ResponseEntity.ok(bookingService.createBookingWithPayment(request, authentication.getName()));
    }
    ...
    public ResponseEntity<BookingResponse> acceptBooking(
        ...
        return ResponseEntity.ok(bookingService.acceptBooking(id, authentication.getName()));
    }
